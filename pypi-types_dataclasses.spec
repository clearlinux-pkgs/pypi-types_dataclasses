...
Source0  : https://files.pythonhosted.org/packages/4b/29/e9014f2aea3ea4b7ac3d42505698932b3eef6af5db02ed6817c0c94344ad/types-dataclasses-0.6.4.tar.gz
...
%prep
%setup -q -n types-dataclasses-0.6.4
cd %{_builddir}/types-dataclasses-0.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641943650
